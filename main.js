...
import { ProgressAPI, StickerAPI, FavoritesAPI } from './supabase.js';
...
function renderStoryPage() {
    ...
    viewer.innerHTML = `
        ...
        <button class="back-btn" style="margin-top:12px;align-self:center" onclick="window.closeStory()">← Cerrar cuento</button>
    `;
